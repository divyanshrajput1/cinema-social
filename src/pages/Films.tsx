...
import { useInfiniteDiscover, useInfiniteSearch, useGenres, TMDBMovie, DiscoverFilters } from "@/hooks/useTMDB";
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              {isSearching 
                ...
                : getActiveFilterLabel() || 'Discover films from our database'
              }
            </p>
          </div>
          ...
          {!isLoading && movies.length > 0 && (
            <p className="text-sm text-muted-foreground mb-6">
              Showing {movies.length.toLocaleString()} of {totalResults.toLocaleString()} films
            </p>
          )}
            ...
            <div className="text-center py-16">
              <p className="text-xl text-muted-foreground mb-4">
                {isSearching 
                  ...
                  : 'No films found with the selected filters'
                }
              </p>
